...
\begin{frame}{Topic 5 Outline}
    \begin{block}{Topic Objective}
        Analysis of AArch64 Instruction Set Architecture specifications for arithmetic computation, bitwise logic manipulation, barrel-shifter operations, and immediate constant handling.
    \end{block}
    \vspace{0.4em}
    \begin{itemize}
...
% --- Slide 15: The Built-in Barrel Shifter ---
...
% --- Slide 16: Barrel Shifter Variations ---
...
% --- Slide 17: Shift Amounts and Width Limits ---
...
% --- Slide 19: Handling Constants in Instructions ---
...
% --- Slide 20: Immediate Arithmetic Constraints ---
...
% --- Slide 21: Logical Immediate Bitmask Generation ---
...
% --- Slide 22: Loading Large Constants: MOVZ and MOVK ---
...
% --- Slide 23: Combining Arithmetic, Logic, and Shifts ---
...
% --- Slide 24: Condition Flag Integration ---
...
% --- Slide 25: Performance Implications ---
...
% --- Slide 32: Review & Concept Verification ---
...
% --- Slide 33: Additional Review & Practice ---
...
% --- Slide 34: Advanced Lab Prep ---
\begin{frame}{Advanced Laboratory Preparation}
    \begin{block}{Next Lab Preview}
        Upcoming laboratory session transition from register-level arithmetic to memory load and store mechanics:
        \begin{itemize}
            \item Inspecting register dumps in QEMU during arithmetic transformations.
            \item Profiling execution time differences between barrel-shifted operands and standalone shift instructions.
        \end{itemize}
    \end{block}
\end{frame}
