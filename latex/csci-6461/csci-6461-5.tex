...
\begin{enumerate}\setlength{\itemsep}{10pt}
  ...
  \item \key{Memory Performance and Alignment}
  \begin{itemize}
    \item Moving double-word pairs efficiently with \code{ldp} and \code{stp}.
    \item Alignment rules and stack-related memory accesses.
  \end{itemize}
\end{enumerate}
...
\begin{tikzpicture}[scale=0.92, every node/.style={transform shape}]
  ...
  \draw[fill=lightblue, draw=navy, thick] (10.4,0) rectangle (12.0,0.65);
  \node at (11.2, 0.325) {\footnotesize\textbf{Byte (7:0)}};
