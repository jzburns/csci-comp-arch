...
{\color{gold}\normalsize\bfseries
CSCI 6461 \;|\; Computer Systems Architecture \;|\; TOPIC 5
\par}

\vspace{0.25cm}

{\color{white}\fontsize{24}{28}\selectfont\bfseries
Memory Architecture\\[0.08cm]\& Addressing Principles
\par}

\vspace{0.35cm}

{\color{white!80}\large
The load/store model, address computation, data sizing,\\and memory hierarchy interactions in AArch64
\par}
...
\begin{frame}{The Memory Access Problem}
\large
...
\begin{frame}{Uses of Paired Transfers}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.48\textwidth}
