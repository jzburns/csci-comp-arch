...
The CISC machine executes fewer instructions, but the RISC machine still wins because its lower CPI 
more than offsets the higher instruction count.
\end{frame}
...
\item Apple Silicon brought AArch64 processors into mainstream laptop
...
\begin{itemize}
\item Cloud providers now deploy AArch64 processors for general-purpose
      server workloads.
\item Google Axion is a custom AArch64 CPU designed for Google Cloud
...
\begin{frame}{Data-Center Workloads: What Runs on AArch64?}
