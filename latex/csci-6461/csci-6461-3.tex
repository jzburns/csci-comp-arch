...
\footnotesize Analysis focuses on \key{EL0} execution mechanics and the \key{EL0 $\to$ EL1} system call boundary. The diagram shows typical paths; exact exception routing is configuration-dependent.
\end{block}
\end{column}
