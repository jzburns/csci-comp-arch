...
\begin{itemize}\setlength{\itemsep}{5pt}
  ...
  \item \key{Instruction Conventions:} Assembly syntax, immediate construction, and basic load/store notation prepare for the detailed addressing-mode treatment in Topic 5.
\end{itemize}
\vfill
\end{frame}
