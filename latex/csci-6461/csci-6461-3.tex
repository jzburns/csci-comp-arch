...
% ============================================================
% Slide 16 (Box removed, plain text used instead)
% ============================================================
...
\vspace{0.15cm}
\footnotesize AArch64 is bi-endian by design, but standard OS environments (Linux, macOS, Windows) execute in \key{little-endian} mode.
\end{frame}
...
\begin{itemize}\setlength{\itemsep}{3pt}
  \item \textbf{ALU \& Barrel Shifting:} Mastering arithmetic operations and free zero-penalty second-operand shifts.
  \item \textbf{Bitwise Logic \& Field Extraction:} Efficiently manipulating bits with masks, bit clears, and \code{ubfx}.
  \item \textbf{Condition Flags \& Comparisons:} Leveraging NZCV bits and choosing between signed vs.\ unsigned branch conditions.
  \item \textbf{Control Flow \& Branchless Selection:} Translating loops and \code{if-else} blocks, and using \code{csel} to eliminate branch penalties.
\end{itemize}
