...
\begin{enumerate}\setlength{\itemsep}{7pt}
  ...
  \begin{itemize}
    \item Instruction syntax, immediate construction, and explicit load/store memory access.
  \end{itemize}
\end{enumerate}
\vfill
\end{frame}
...
\begin{itemize}\setlength{\itemsep}{5pt}
  ...
  \item \key{Instruction Conventions:} Assembly syntax, immediate construction, and basic memory-reference forms establish the notation used in later programming topics.
\end{itemize}
\vfill
\end{frame}
...
\begin{enumerate}\setlength{\itemsep}{9pt}
  \item \key{Memory Addressing Modes:} Explain the mechanical difference in address calculation and base-register updates between \code{ldr x1, [x0, \#16]}, \code{ldr x1, [x0, \#16]!}, and \code{ldr x1, [x0], \#16}.
