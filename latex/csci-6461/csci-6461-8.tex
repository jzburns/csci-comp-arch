...
\begin{tikzpicture}[node distance=1.0cm,font=\small]
  \node[draw=none,inner sep=0pt] (imm) {\ExtendSymbol[0.28]};
  \node[draw=none,inner sep=0pt,right=1.2cm of imm] (alu) {\ALUSymbol[0.26]};
  \draw[arr] (imm.east)--node[above,font=\scriptsize]{ExtImm}(alu.west);
\end{tikzpicture}
\end{center}
\end{frame}
