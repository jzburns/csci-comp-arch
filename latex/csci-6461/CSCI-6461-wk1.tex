...
\begin{frame}{Week 1 Summary and Next Steps}
...
\begin{itemize}
  ...
  \item \key{Next Module:} The AArch64 Programmer's Model, General-Purpose Registers (\bits{x0}--\bits{x30}), and Core Instructions (\bits{add}, \bits{sub}, \bits{ldr}, \bits{str}).
\end{itemize}
