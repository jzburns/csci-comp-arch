...
\begin{frame}{Week 1: Module Topics}
...
\begin{frame}{Week 1: Comprehensive Summary}
...
\begin{itemize}\setlength{\itemsep}{7pt}
  ...
  \item \key{Forward Transition:} Week 2 explores the AArch64 programmer's model, register conventions (\bits{x0}--\bits{x30}), and core arithmetic/memory instructions.
\end{itemize}
